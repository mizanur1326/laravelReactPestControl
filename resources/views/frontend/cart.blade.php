            ...
            @foreach(session('cart') as $id => $details)
                ...
                <tr data-id="{{ $id }}">
                    ...
                    <td class="actions" data-th="">
                        <button class="btn btn-danger btn-sm remove-from-cart"><a class="text-white" href="{{route('remove.from.cart')}}">Remove</a></button>
                    </td>
                </tr>
            @endforeach
        @endif
    ...
    <tfoot>
        ...
        <tr>
            <td colspan="5" class="text-right">
                <a href="{{ url('/packege') }}" class="btn btn-warning"><i class="fa fa-angle-left"></i> Continue Shopping</a>
