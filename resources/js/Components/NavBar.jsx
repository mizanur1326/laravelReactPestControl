    ...
    <div classname="container">
      <nav classname="navbar navbar-dark navbar-expand-lg py-lg-0">
        <a href="index.html" classname="navbar-brand">
          <h1 classname="text-primary mb-0 display-5">Pest<span classname="text-white">Kit</span><i classname="fa fa-spider text-primary ms-2" /></h1><i classname="fa fa-spider text-primary ms-2">
          </i></a><i classname="fa fa-spider text-primary ms-2">
        ...
        </i></nav><i classname="fa fa-spider text-primary ms-2">
      </i></div><i classname="fa fa-spider text-primary ms-2">
    </i></div><i classname="fa fa-spider text-primary ms-2">
  </i></div>
